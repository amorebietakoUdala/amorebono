 ...
 *     },
 * }
 * @psalm-type GiltzaConfig = array{
 *     provider?: array{
 *         clientId: scalar|Param|null, // Giltza client ID
 *         clientSecret: scalar|Param|null, // Giltza client secret
 *         redirectUri?: scalar|Param|null, // URL that redirects to giltza authentication // Default: "amreu_giltza_login"
 *         urlAuthorize?: scalar|Param|null, // Giltza authorization URL // Default: "https://eidas.izenpe.com/trustedx-authserver/oauth/izenpe"
 *         urlAccessToken?: scalar|Param|null, // Giltza access token URL // Default: "https://eidas.izenpe.com/trustedx-authserver/oauth/izenpe/token"
 *         urlResourceOwnerDetails?: scalar|Param|null, // Giltza resource owner details URL // Default: "https://eidas.izenpe.com/trustedx-resources/openid/v1/users/me"
 *     },
 *     controller?: array{
 *         successUri: scalar|Param|null, // URL to go to after successful giltza login. For example: ("amreu_giltza_success")
 *         response_type?: scalar|Param|null, // Default: "code"
 *         scope?: scalar|Param|null, // Default: "urn:izenpe:identity:global"
 *         prompt?: scalar|Param|null, // Default: "login"
 *         ui_locales?: scalar|Param|null, // Default: "eu"
